...
class ARPSetupProxy(object):
    ...
    information necessary to build the ARP attack packets
    """
    ...
    def __set_gateway_ip(self, gateway_ip: str) -> str:
        ...
        native byte order hexadecimal representation to a string with the IPv4 address in
